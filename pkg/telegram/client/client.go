...
// --------------------------------------------------------------- Types ---------------------------------------------------------------
type UpdatesChannel chan models.Update
...
func (tc *Client) SendMessage(ctx context.Context, chatId, text string, opts ...SendMessageOption) (*models.Message, error) {
	q := url.Values{}
...
func (tc *Client) EditMessageText(ctx context.Context, chatId, messageId, text string, opts ...SendMessageOption) (*models.Message, error) {
	q := url.Values{}
	q.Add("chat_id", chatId)
	q.Add("message_id", messageId)
	q.Add("text", text)
...
func (tc *Client) AnswerCallbackQuery(ctx context.Context, update *models.Update) error {
...
func (tc *Client) GetChat(ctx context.Context, chatId string) (*models.GetChatResponse, error) {
	q := url.Values{}
	q.Add("chat_id", chatId)

	tc.logger.Debug("Telegram client", "chat id", chatId)

	model := models.GetChatResponse{}
...
func (tc *Client) GetUpdates(ctx context.Context, offset int) (*models.UpdateResponse, error) {
	q := url.Values{}
...
func (tc *Client) GetChatMember(ctx context.Context, userId string) (*models.SingleChatMemberResponse, error) {
	q := url.Values{}
	q.Add("chat_id", userId)
	q.Add("user_id", userId)

	model := models.SingleChatMemberResponse{}
