...
func (c *Client) SendDocument(ctx context.Context, chatId string, file []byte, filename string, opts ...SendMessageOption) (*models.SendDocumentResponse, error) {
	var (
		result models.SendDocumentResponse
		b      bytes.Buffer
		q      = make(url.Values)
	)
